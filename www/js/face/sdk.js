/*1411325613,,JIT Construction: v1422324,es_LA*/
...
try {
    window.FB || (function(window) {
        ...
        __d("ES", ["ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "JSON3", "ES6Object", "ES6ArrayPrototype", "ES6DatePrototype", "ES6Number"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
            ...
            v(u);
            function w(x, y, z) {
                var aa = Array.prototype.slice.call(arguments, 3), ba = z ? r.call(x).slice(8, -1) + '.prototype' : x, ca = s[ba + '.' + y] || x[y];
                if (typeof ca === 'function')
                    return ca.apply(x, aa);
            }
            e.exports = w;
        }, null);
        var ES = require('ES');
        __d("JSSDKRuntimeConfig", [], {"locale": "es_LA", "rtl": false, "revision": "1422324"});
        ...
        __d("sdk.createIframe", ["guid", "hasNamePropertyBug", "DOMEventListener"], function(a, b, c, d, e, f, g, h, i) {
            function j(k) {
                ...
                var l, m = k.name || g(), n = k.root, o = k.style || {border: 'none'}, p = k.url, q = k.onload, r = k.onerror;
                if (h()) {
                ...
                delete k.onload;
                delete k.onerror;
                var s = ES('Object', 'assign', false, {frameBorder: 0, allowTransparency: true, scrolling: 'no'}, k);
                if (s.width)
                    l.width = s.width + 'px';
                if (s.height)
                ...
                for (var t in s)
                    if (s.hasOwnProperty(t))
                        l.setAttribute(t, s[t]);
                ES('Object', 'assign', false, l.style, o);
                l.src = "javascript:false";
                n.appendChild(l);
                if (q)
                    var u = i.add(l, 'load', function() {
                        u.remove();
                        q();
                    });
                if (r)
                    var v = i.add(l, 'error', function() {
                        v.remove();
                        r();
                    });
                l.src = p;
            ...
            function i(j) {
                ...
                if (document.attachEvent) {
                    ...
                    if (j.title)
                        p.title = j.title;
                    if (j.className)
                        p.className = j.className;
                    if (j.height !== undefined)
                        p.style.height = j.height + 'px';
                    if (j.width !== undefined)
                        if (j.width == '100%') {
                            p.style.width = j.width;
                        } else
                            p.style.width = j.width + 'px';
        ...
        __d("sdk.Impressions", ["sdk.Content", "guid", "insertIframe", "Miny", "QueryString", "sdk.Runtime", "UrlMap"], function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
            function n(p) {
                ...
                var r = m.resolve('www', true) + '/impression.php/' + h() + '/', s = k.appendToUrl(r, p);
                if (s.length > 2000)
                ...
                if (s.length <= 2000) {
                    ...
                    var v = h(), w = g.appendHidden('');
                    i({url: 'javascript:false', root: w, name: v, className: 'fb_hidden fb_invisible', onload: function() {
                            w.parentNode.removeChild(w);
                        }});
                    g.submitToTarget({url: r, target: v, params: p});
                }
            }
            var o = {log: function(p, q) {
                    if (!q.source)
                        q.source = 'jssdk';
                    n({lid: p, payload: ES('JSON', 'stringify', false, q)});
                }, impression: n};
            e.exports = o;
        }, null);
        ...
        __d("URIBase", ["URIRFC3986", "URISchemes", "copyProperties", "ex", "invariant"], function(a, b, c, d, e, f, g, h, i, j, k) {
            ...
            function n(p, q, r, s) {
                ...
                if (t.userinfo !== null)
                    if (r) {
                        ...
                        return false;
                if (!p.getDomain() && ES(p.getPath(), 'indexOf', true, '\\') !== -1)
                    if (r) {
            ...
            o.prototype.setDomain = function(p) {
                "use strict";
                if (l.test(p))
                    throw new Error(j('URI.setDomain: unsafe domain specified: %s for url %s', p, this.toString()));
                this.$URIBase2 = p;
                return this;
            };
        ...
        __d("sdk.Event", [], function(a, b, c, d, e, f) {
            var g = {SUBSCRIBE: 'event.subscribe', UNSUBSCRIBE: 'event.unsubscribe', subscribers: function() {
        ...
        __d("JSONRPC", ["Log"], function(a, b, c, d, e, f, g) {
            ...
            h.prototype.stub = function(i) {
                ...
                this.remote[i] = ES(function() {
                    var j = Array.prototype.slice.call(arguments, 0), k = {jsonrpc: '2.0', method: i};
                    if (typeof j[j.length - 1] == 'function') {
                        k.id = ++this.$JSONRPC0;
                        this.$JSONRPC1[k.id] = j.pop();
                    }
                    k.params = j;
                    this.$JSONRPC3(ES('JSON', 'stringify', false, k), this.$JSONRPC2 || {method: i});
                }, 'bind', true, this);
            };
        ...
        __d("sdk.RPC", ["Assert", "JSONRPC", "Queue"], function(a, b, c, d, e, f, g, h, i) {
            var j = new i(), k = new h(function(m) {
                j.enqueue(m);
            }), l = {local: k.local, remote: k.remote, stub: ES(k.stub, 'bind', true, k), setInQueue: function(m) {
                    g.isInstanceOf(i, m);
                    m.start(function(n) {
                        k.read(n);
                    });
        ...
        __d("sdk.XD", ["sdk.Content", "sdk.Event", "Log", "QueryString", "Queue", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "UrlMap", "JSSDKXDConfig", "XDM", "isFacebookURI", "sdk.createIframe", "sdk.feature", "guid"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
            var w = new k(), x = new k(), y = new k(), z, aa, ba = v(), ca = q.useCdn ? 'cdn' : 'www', da = u('use_bundle') ? q.XdBundleUrl : q.XdUrl, ea = p.resolve(ca, false) + da, fa = p.resolve(ca, true) + da, ga = v(), ha = location.protocol + '//' + location.host, ia, ja = false, ka = 'Facebook Cross Domain Communication Frame', la = {}, ma = new k();
            l.setInQueue(ma);
            function na(ta) {
            ...
            function ra(ta) {
                if (ja)
                    return;
                var ua = g.appendHidden(document.createElement('div')), va = r.create({blacklist: null, root: ua, channel: ga, flashUrl: q.Flash.path, whenReady: function(wa) {
                        ia = wa;
                        var xa = {channel: ga, origin: location.protocol + '//' + location.host, transport: va, xd_name: ta}, ya = '#' + j.encode(xa);
                        if (m.getSecure() !== true)
                            z = t({url: ea + ya, name: 'fb_xdm_frame_http', id: 'fb_xdm_frame_http', root: ua, 'aria-hidden': true, title: ka, tabindex: -1});
                        aa = t({url: fa + ya, name: 'fb_xdm_frame_https', id: 'fb_xdm_frame_https', root: ua, 'aria-hidden': true, title: ka, tabindex: -1});
                    }, onMessage: pa});
                if (!va)
                    n.log('jssdk_error', {appId: m.getClientID(), error: 'XD_TRANSPORT', extra: {message: 'Failed to create a valid transport'}});
                ja = true;
            }
            var sa = {rpc: l, _callbacks: {}, _forever: {}, _channel: ga, _origin: ha, onMessage: pa, recv: pa, init: ra, sendToFacebook: qa, inform: function(ta, ua, va, wa) {
                    qa('facebook', {method: ta, params: ES('JSON', 'stringify', false, ua || {}), behavior: wa || 'p', relation: va});
            ...
            h.subscribe('init:post', function(ta) {
                ...
                if (ua)
                    setTimeout(function() {
                        ...
                        if (!va)
                            n.log('jssdk_error', {appId: m.getClientID(), error: 'XD_INITIALIZATION', extra: {message: 'Failed to initialize in ' + ua + 'ms'}});
                    }, ua);
            });
            e.exports = sa;
        }, null);
            ...
            function z(da, ea, fa) {
                return function(ga) {
                    ...
                    if (ga && ga.https == 1)
                        p.setSecure(true);
                    if (da)
                        da({authResponse: ea, status: p.getLoginStatus()});
                    return ea;
                };
            }
            function aa(da) {
                ...
                var ga = z(da, u, 'login_status'), ha = s(r.resolve('www', true) + '/connect/ping').setQueryData({client_id: p.getClientID(), response_type: 'token,signed_request,code', domain: location.hostname, origin: k(), redirect_uri: t.handler(function(ia) {
        ...
        __d("sdk.DOM", ["Assert", "createArrayFrom", "sdk.domReady", "UserAgent_DEPRECATED"], function(a, b, c, d, e, f, g, h, i, j) {
            ...
            function s(z, aa, ba) {
                ...
                if (aa.querySelectorAll)
                    return h(aa.querySelectorAll(ba + '.' + z));
            ...
            var y = {containsCss: p, addCss: q, removeCss: r, getByClass: s, getStyle: t, setStyle: u, getAttr: l, getBoolAttr: m, getProp: n, html: o, addCssRules: v, getViewportInfo: w, getPosition: x, ready: i};
            e.exports = y;
        }, null);
            ...
            function j(l, m, n, o) {
                ...
                q.onerror = function(r) {
                    if (r.responseText) {
                        ...
                        o({error: {type: 'http', message: 'unknown error', status: r.status}});
                };
                q.send(p);
                return true;
            }
        ...
        __d("ApiClient", ["ArgumentError", "Assert", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "sprintf", "sdk.URI", "UrlMap", "ApiClientConfig", "invariant"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
            var t, u, v, w = {get: true, post: true, 'delete': true, put: true}, x = {fql_query: true, fql_multiquery: true, friends_get: true, notifications_get: true, stream_get: true, users_getinfo: true}, y = [], z = [], aa = null, ba = 50, ca = 105440539523;
            function da(la, ma, na, oa) {
                if (v)
                    na = ES('Object', 'assign', false, {}, v, na);
                na.access_token = na.access_token || t;
                na.pretty = na.pretty || 0;
                na = k(na);
                var pa = {jsonp: l, cors: i, flash: j}, qa;
                if (na.transport) {
                    qa = [na.transport];
                    delete na.transport;
                } else
                ...
                for (var ra = 0; ra < qa.length; ra++) {
                    var sa = pa[qa[ra]], ta = ES('Object', 'assign', false, {}, na);
                    if (sa.execute(la, ma, ta, oa))
                        return;
                }
                oa({error: {type: 'no-transport', message: 'Could not find a usable transport for request'}});
            }
            ...
            function fa(la) {
                ...
                var qa = (oa.string || 'get').toLowerCase();
                h.isTrue(w.hasOwnProperty(qa), o('Invalid method passed to ApiClient: %s', qa));
                var ra = oa['function'];
                if (!ra)
                    m.warn('No callback passed to the ApiClient');
                if (oa.object)
                    na.addQueryData(oa.object);
                var sa = na.getQueryData();
                sa.method = qa;
                return {uri: na, callback: ra, params: sa};
            }
            function ga() {
                var la = Array.prototype.slice.call(arguments, 0), ma = fa(la), na = ma.uri, oa = ma.callback, pa = ma.params, qa = pa.method, ra = na.getProtocol() && na.getDomain() ? na.setQueryData({}).toString() : q.resolve('graph') + na.getPath();
                da(ra, qa == 'get' ? 'get' : 'post', pa, ES(ea, 'bind', true, null, oa, na.getPath(), qa, pa));
            }
            function ha() {
                var la = Array.prototype.slice.call(arguments, 0), ma = fa(la), na = ma.uri, oa = ma.callback, pa = ma.params, qa = pa.method, ra = {method: qa, relative_url: na.removeQueryData('method').toString()};
                if (qa.toLowerCase() == 'post') {
                    ra.body = na.getQueryData();
                    ra.relative_url = na.setQueryData({}).toString();
                }
                y.push(ra);
                z.push(oa);
                if (y.length == ba) {
            ...
            function ia() {
                ...
                z = [];
                aa = null;
                ga('/', 'POST', {batch: ES('JSON', 'stringify', false, la), include_headers: false, batch_app_id: u || ca}, function(na) {
                    if (ES('Array', 'isArray', false, na)) {
                        ES(na, 'forEach', true, function(oa, pa) {
                            ma[pa](ES('JSON', 'parse', false, oa.body));
                        });
                    } else
                        ES(ma, 'forEach', true, function(oa) {
                            return oa({error: {message: 'Fatal: batch call failed.'}});
                        });
                });
            }
            function ja(la, ma) {
                ...
                if (!ma)
                    m.warn('No callback passed to the ApiClient');
                var na = la.method.toLowerCase().replace('.', '_');
                la.format = 'json-strings';
                la.api_key = u;
                var oa = na in x ? 'api_read' : 'api', pa = q.resolve(oa) + '/restserver.php', qa = ES(ea, 'bind', true, null, ma, '/restserver.php', 'get', la);
                da(pa, 'get', la, qa);
            }
            var ka = ES('Object', 'assign', false, new n(), {setAccessToken: function(la) {
                    t = la;
                }, setClientID: function(la) {
                    u = la;
                }, setDefaultParams: function(la) {
                    v = la;
                }, rest: ja, graph: ga, scheduleBatchCall: ha});
        ...
        __d("sdk.AppEvents", ["Assert", "sdk.Impressions", "merge", "sdk.Runtime"], function(a, b, c, d, e, f, g, h, i, j) {
            ...
            e.exports = {activateApp: s, logEvent: p, logPurchase: r, isValidEventName: q, EventNames: k, ParameterNames: m};
        }, null);
        __d("legacy:fb.appevents", ["Assert", "sdk.AppEvents", "FB", "sdk.feature", "sdk.Runtime"], function(a, b, c, d, e, f, g, h, i, j, k) {
            i.provide('AppEvents', {logEvent: function(l, m, n) {
        ...
        __d("sdk.Dialog", ["sdk.Canvas.Environment", "sdk.Content", "sdk.DOM", "DOMEventListener", "sdk.Intl", "ObservableMixin", "sdk.Runtime", "Type", "UserAgent_DEPRECATED", "sdk.feature"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
            ...
            var w = n.extend({constructor: function y(z, aa) {
                    ...
                    var y = o.nativeApp() ? '' : ('<table>' + '  <tbody>' + '    <tr>' + '      <td class="header_left">' + '        <label class="touchable_button">' + '          <input type="submit" value="' + k.tx._("Cancelar") + '"' + '            id="fb_dialog_loader_close"/>' + '        </label>' + '      </td>' + '      <td class="header_center">' + '        <div>' + k.tx._("Cargando...") + '</div>' + '      </td>' + '      <td class="header_right">' + '      </td>' + '    </tr>' + '  </tbody>' + '</table>');
                    ...
                    if (!x._loaderEl)
                        x._loaderEl = x._findRoot(o.mobile() ? x._createMobileLoader() : x._createWWWLoader(z));
                    if (!y)
                        y = function() {
                        };
                    ...
                    if (o.ie()) {
                        ...
                        ba += o.mobile() ? ' fb_dialog_mobile' : ' fb_dialog_advanced';
                    if (y.content)
        ...
        __d("sdk.Native", ["Log", "UserAgent_DEPRECATED"], function(a, b, c, d, e, f, g, h) {
            var i = 'fbNativeReady', j = {onready: function(k) {
                    if (!h.nativeApp()) {
        ...
        __d("sdk.UIServer", ["sdk.Auth", "sdk.Content", "createObjectFrom", "sdk.Dialog", "sdk.DOM", "sdk.Event", "flattenObject", "sdk.Frictionless", "sdk.getContextType", "guid", "insertIframe", "Log", "sdk.Native", "QueryString", "resolveURI", "sdk.RPC", "sdk.Runtime", "JSSDKConfig", "UrlMap", "UserAgent_DEPRECATED", "sdk.XD"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa) {
            var ba = {transform: function(ea) {
                    ...
                    return da.getXdRelation(ea);
                }}, ca = {'stream.share': {size: {width: 670, height: 340}, url: 'sharer.php', transform: function(ea) {
                        if (!ea.params.u)
                            ea.params.u = window.location.toString();
                        ea.params.display = 'popup';
                        return ea;
                    }}, apprequests: {transform: function(ea) {
                        ea = ba.transform(ea);
                        ...
                        ea.closeIcon = false;
                        return ea;
                    }, getXdRelation: ba.getXdRelation}, feed: ba, 'permissions.oauth': {url: 'dialog/oauth', size: {width: (z.mobile() ? null : 475), height: (z.mobile() ? null : 183)}, transform: function(ea) {
                        if (!w.getClientID()) {
                        ...
                        if (g.getAuthResponse() && !ea.params.scope && !ea.params.auth_type) {
                            ...
                            ea.cb && ea.cb({status: w.getLoginStatus(), authResponse: g.getAuthResponse()});
                            return;
                        }
                        var fa = ea.cb, ga = ea.id;
                        delete ea.cb;
                        var ha = ES('Object', 'keys', false, ES('Object', 'assign', false, ea.params.response_type ? i(ea.params.response_type.split(',')) : {}, {token: true, signed_request: true})).join(',');
                        if (ea.params.display === 'async') {
                            ES('Object', 'assign', false, ea.params, {client_id: w.getClientID(), origin: o(), response_type: ha, domain: location.hostname});
                            ea.cb = g.xdResponseWrapper(fa, g.getAuthResponse(), 'permissions.oauth');
                        } else
                            ES('Object', 'assign', false, ea.params, {client_id: w.getClientID(), redirect_uri: u(da.xdHandler(fa, ga, 'opener', g.getAuthResponse(), 'permissions.oauth')), origin: o(), response_type: ha, domain: location.hostname});
                        return ea;
                    }}, 'auth.logout': {url: 'logout.php', transform: function(ea) {
                        if (!w.getClientID()) {
                    ...
                    }}, 'login.status': {url: 'dialog/oauth', transform: function(ea) {
                        var fa = ea.cb, ga = ea.id;
                        delete ea.cb;
                        ES('Object', 'assign', false, ea.params, {client_id: w.getClientID(), redirect_uri: da.xdHandler(fa, ga, 'parent', g.getAuthResponse(), 'login_status'), origin: o(), response_type: 'token,signed_request,code', domain: location.hostname});
                        return ea;
                    }}}, da = {Methods: ca, _loadedNodes: {}, _defaultCb: {}, _resultToken: '"xxRESULTTOKENxx"', genericTransform: function(ea) {
                    if (ea.params.display == 'dialog' || ea.params.display == 'iframe')
                        ES('Object', 'assign', false, ea.params, {display: 'iframe', channel: da._xdChannelHandler(ea.id, 'parent.parent')}, true);
                    return ea;
                    ...
                    for (var ha = 0; ha < ga.length; ha++)
                        if (!x.initSitevars.iframePermissions[ES(ga[ha], 'trim', true)])
                            return 'popup';
                    return ea.display;
                }, prepareCall: function(ea, fa) {
                    var ga = ea.method.toLowerCase(), ha = da.Methods.hasOwnProperty(ga) ? ES('Object', 'assign', false, {}, da.Methods[ga]) : {}, ia = p(), ja = w.getSecure() || (ga !== 'auth.status' && ga != 'login.status');
                    ES('Object', 'assign', false, ea, {app_id: w.getClientID(), locale: w.getLocale(), sdk: 'joey', access_token: ja && w.getAccessToken() || undefined});
                    ...
                    if (w.getIsVersioned() && ha.url.substring(0, 7) === 'dialog/')
                        ha.url = ea.version + '/' + ha.url;
                    var ka = {cb: fa, id: ia, size: ha.size || da.getDefaultSize(), url: y.resolve(ea.display == 'touch' ? 'm' : 'www', ja) + '/' + ha.url, params: ea, name: ga, dialog: j.newInstance(ia, ea.display)}, la = ha.transform ? ha.transform : da.genericTransform;
                    if (la) {
                        ka = la(ka);
                        if (!ka)
                            return;
                    ...
                    if (na === 'parent')
                        ES('Object', 'assign', false, ka.params, {channel_url: da._xdChannelHandler(ia, 'parent.parent')}, true);
                    ...
                    ea.root = j.create({onClose: fa, closeIcon: ea.closeIcon === undefined ? true : ea.closeIcon, classes: (z.ipad() ? 'centered' : '')});
                    if (!ea.hideLoader)
                    ...
                    if (ea.post) {
                        q({url: 'about:blank', root: ea.root, className: ea.className, width: ea.size.width, height: ea.size.height, id: ea.id, onInsert: fa, onload: function(ga) {
                                h.submitToTarget({url: ea.url, target: ga.name, params: ea.params});
                            }});
                    } else
                        q({url: ea.url, root: ea.root, className: ea.className, width: ea.size.width, height: ea.size.height, id: ea.id, name: ea.frameName, onInsert: fa});
                    ...
                    da._xdRecv({frame: ea}, da._defaultCb[ea] || function() {
                    });
                    ...
                    if (ga)
                        ...
                        } else if (k.containsCss(ga, 'FB_UI_Dialog'))
                            j.remove(ga);
        ...
        __d("sdk.Canvas.Plugin", ["sdk.api", "sdk.RPC", "Log", "UserAgent_DEPRECATED", "sdk.Runtime", "createArrayFrom"], function(a, b, c, d, e, f, g, h, i, j, k, l) {
            ...
            function u(aa) {
                var ba = aa.type ? aa.type.toLowerCase() : null, ca = ba === 'application/x-shockwave-flash' || (aa.classid && aa.classid.toUpperCase() == m);
                if (!ca)
                    return false;
                var da = /opaque|transparent/i;
                if (da.test(aa.getAttribute('wmode')))
                    return false;
                for (var ea = 0; ea < aa.childNodes.length; ea++) {
                    var fa = aa.childNodes[ea];
                    if (/param/i.test(fa.nodeName) && /wmode/i.test(fa.name) && da.test(fa.value))
                        return false;
                }
                return true;
            }
        ...
        __d("legacy:fb.event", ["FB", "sdk.Event", "sdk.Runtime", "sdk.Scribe", "sdk.feature"], function(a, b, c, d, e, f, g, h, i, j, k) {
            ...
            g.provide('Event', {subscribe: function(o, p) {
                    if (n) {
                        l.push(o);
                        if (!m)
        ...
        __d("legacy:fb.pay", ["copyProperties", "sdk.Runtime", "sdk.UIServer", "sdk.XD", "sdk.feature", "FB"], function(a, b, c, d, e, f, g, h, i, j, k) {
            b('FB');
            var l = {error_code: 1383001, error_message: 'An unknown error caused the dialog to be closed'}, m = function(n) {
                return function(o) {
            ...
            g(i.Methods, {pay: {size: {width: 555, height: 120}, connectDisplay: 'popup', transform: function(n) {
        ...
        __d("XFBML", ["Assert", "createArrayFrom", "sdk.DOM", "sdk.feature", "sdk.Impressions", "Log", "ObservableMixin", "runOnce", "UserAgent_DEPRECATED"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
            ...
            function v(ba) {
                return p[t(ba, 'nodeName').toLowerCase()] || p[u(ba).toLowerCase()];
            }
            function w(ba) {
                var ca = ES(ES(t(ba, 'className'), 'trim', true).split(/\s+/), 'filter', true, function(da) {
                    return q.hasOwnProperty(da);
                });
                if (ca.length === 0)
                    return undefined;
                if (ba.getAttribute('fb-xfbml-state') || !ba.childNodes || ba.childNodes.length === 0 || (ba.childNodes.length === 1 && ba.childNodes[0].nodeType === 3) || (ba.children.length === 1 && t(ba.children[0], 'className') === 'fb-xfbml-parse-ignore'))
                    return q[ca[0]];
            }
            function x(ba) {
                var ca = {};
            ...
            function z(ba, ca, da) {
                ...
                ES(h(ba.getElementsByTagName('*')), 'forEach', true, function(ja) {
                    if (!da && ja.getAttribute('fb-xfbml-state'))
                        return;
                    if (ja.nodeType !== 1)
                        return;
                    var ka = v(ja) || w(ja);
                    if (!ka)
                        return;
                    if (o.ie() < 9 && ja.scopeName)
                        ja = y(ja, ka.xmlns, ka.localName);
                    fa++;
                    ga++;
                ...
                setTimeout(function() {
                    if (fa > 0)
                        l.warn('%s tags failed to render in %s ms', fa, ia);
                }, ia);
                ha();
            }
            ...
            ES('Object', 'assign', false, s, {registerTag: function(ba) {
                    var ca = ba.xmlns + ':' + ba.localName;
                    g.isUndefined(p[ca], ca + ' already registered');
                    p[ca] = ba;
                    q[ba.xmlns + '-' + ba.localName] = ba;
                }, parse: function(ba, ca) {
                    z(ba || document.body, ca || function() {
                    }, true);
                }, parseNew: function() {
                    z(document.body, function() {
                    }, false);
                }});
            if (j('log_tag_count')) {
                var aa = function(ba, ca) {
                    s.unsubscribe('parse', aa);
                    setTimeout(ES(k.log, 'bind', true, null, 102, {tag_count: ca}), 5000);
                };
        ...
        __d("PluginPipe", ["sdk.Content", "sdk.feature", "guid", "insertIframe", "Miny", "ObservableMixin", "JSSDKPluginPipeConfig", "sdk.Runtime", "UrlMap", "UserAgent_DEPRECATED", "XFBML"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
            ...
            function w(x) {
                ...
                var ca = o.resolve('www', n.getSecure()) + '/plugins/pipe.php', da = i();
                j({url: 'about:blank', root: y, name: da, className: 'fb_hidden fb_invisible', onload: function() {
                        g.submitToTarget({url: ca, target: da, params: {plugins: ba.length < aa.length ? ba : aa}});
                    }});
            }
            ES('Object', 'assign', false, r, {add: function(x) {
                    var y = u();
        ...
        __d("IframePlugin", ["sdk.Auth", "sdk.DOM", "sdk.Event", "Log", "ObservableMixin", "sdk.PlatformVersioning", "PluginPipe", "QueryString", "sdk.Runtime", "Type", "sdk.URI", "UrlMap", "UserAgent_DEPRECATED", "sdk.XD", "sdk.createIframe", "guid", "resolveURI"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
            ...
            var fa = p.extend({constructor: function(ga, ha, ia, ja) {
                    ...
                    this.subscribe('xd.resize.flow', ES(function(qa) {
                        ES('Object', 'assign', false, this._config.root.style, {verticalAlign: 'bottom', overflow: ''});
                    ...
                    ca(x, ga, ja, na);
                    ES('Object', 'assign', false, na, {app_id: o.getClientID(), locale: o.getLocale(), sdk: 'joey', kid_directed_site: o.getKidDirectedSite(), channel: t.handler(ES(function(qa) {
                    ...
                    this.subscribe('xd.verify', function(qa) {
                        t.sendToFacebook(oa, {method: 'xd/verify', params: ES('JSON', 'stringify', false, qa.token)});
                    });
                    ...
                    this._tag = ia;
                    this._params = na;
                    this._config = {root: pa, url: ma + n.encode(na), name: oa, width: (s.mobile() ? (void 0) : (na.width || 1000)), height: na.height || 1000, style: {border: 'none', visibility: 'hidden'}, title: this._ns + ':' + this._tag + ' Facebook Social Plugin', onload: ES(function() {
                    ...
                    if (s.mobile()) {
                        ...
                        ES('Object', 'assign', false, this._config.root.style, {width: '100%', height: 'auto'});
        ...
        __d("sdk.XFBML.IframeWidget", ["sdk.Arbiter", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Event", "sdk.XFBML.Element", "guid", "insertIframe", "QueryString", "sdk.Runtime", "sdk.ui", "UrlMap", "sdk.XD"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
            var t = l.extend({_iframeName: null, _showLoader: true, _refreshOnAuthChange: false, _allowReProcess: false, _fetchPreCachedLoader: false, _visibleAfter: 'load', _widgetPipeEnabled: false, _borderReset: false, _repositioned: false, getUrlBits: function() {
                    ...
                    s.sendToFacebook(this.getIframeName(), {method: event, params: ES('JSON', 'stringify', false, x || {}), behavior: y || g.BEHAVIOR_PERSISTENT});
                    ...
                    return ES('Object', 'assign', false, {api_key: p.getClientID(), locale: p.getLocale(), sdk: 'joey', kid_directed_site: p.getKidDirectedSite(), ref: this.getAttribute('ref')}, this.getUrlBits().params);
                }, _getURL: function() {
        ...
        __d("sdk.XFBML.Comments", ["sdk.Event", "sdk.XFBML.IframeWidget", "QueryString", "sdk.Runtime", "JSSDKConfig", "UrlMap", "UserAgent_DEPRECATED"], function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
            var n = h.extend({_visibleAfter: 'immediate', _refreshOnAuthChange: true, setupAndValidate: function() {
                    ...
                    if (!o.href) {
                        ...
                        if (o.migrated)
                            o.href = l.resolve('www') + '/plugins/comments_v1.php?' + 'app_id=' + j.getClientID() + '&xid=' + encodeURIComponent(o.xid) + '&url=' + encodeURIComponent(o.url);
                    } else {
                    ...
                    if (!this._attr.permalink)
                        return {width: this._attr.mobile ? '100%' : this._attr.width, height: 160};
                }, getUrlBits: function() {
        ...
        __d("sdk.XFBML.LoginButton", ["sdk.Helper", "IframePlugin"], function(a, b, c, d, e, f, g, h) {
            var i = h.extend({constructor: function(j, k, l, m) {
                    this.parent(j, k, l, m);
        ...
        __d("sdk.XFBML.Name", ["ApiClient", "escapeHTML", "sdk.Event", "sdk.XFBML.Element", "sdk.Helper", "Log", "sdk.Runtime"], function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
            var n = ({}).hasOwnProperty, o = j.extend({process: function() {
                    ...
                    if (this._uid == m.getUserID() && this._getBoolAttribute('use-you', true)) {
                        ...
                        if (this._firstnameonly && p.first_name !== undefined) {
                            q = h(p.first_name);
                        } else if (this._lastnameonly && p.last_name !== undefined)
                            q = h(p.last_name);
                        if (!q)
                            q = h(p.name);
            ...
            var m = j.extend({getUrlBits: function() {
                    ...
                    switch (this._attr.trigger) {
                        ...
                        case "onvisible":
                            ...
                            return o <= n;
                        default:
                            var p = window.pageYOffset || document.body.scrollTop, q = document.documentElement.scrollHeight;
        ...
        __d("legacy:fb.xfbml", ["Assert", "sdk.domReady", "sdk.Event", "FB", "IframePlugin", "PluginTags", "wrapFunction", "XFBML", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.LoginButton", "sdk.XFBML.Name", "sdk.XFBML.RecommendationsBar", "sdk.XFBML.Registration"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
            var o = {comments: b('sdk.XFBML.Comments'), comments_count: b('sdk.XFBML.CommentsCount'), login_button: b('sdk.XFBML.LoginButton'), name: b('sdk.XFBML.Name'), recommendations_bar: b('sdk.XFBML.RecommendationsBar'), registration: b('sdk.XFBML.Registration')};
            ...
            ES(ES('Object', 'keys', false, o), 'forEach', true, function(q) {
                n.registerTag({xmlns: 'fb', localName: q.replace(/_/g, '-'), ctor: o[q]});
            });
            ...
            i.subscribe('init:post', function(q) {
                if (q.xfbml)
                    setTimeout(m(ES(h, 'bind', true, null, n.parse), 'entry', 'init:post:xfbml.parse'), 0);
            });
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1422324","message":"' + e.message + '"}}');
}