...
(function() {
    function accordion(el, scroll) {
        ...
        // Get the wrappers
        that.wrappers = document.querySelectorAll('#' + el + ' > li');

        // Get the headers
        that.handles = document.querySelectorAll('#' + el + ' > li > .option-title');

        // Get the accordions
        accordions = document.querySelectorAll('#' + el + ' > li > .event-menu');
    ...
    accordion.prototype = {
        ...
        toggle: function(e) {
            var that = this,
                    ...
                    targetHandle = targetWrapper.querySelector('.option-title'),
                    targetAccordion = targetWrapper.querySelector('.event-menu'),
            ...
            if (openedWrapper) {
                ...
                openedAccordion = openedWrapper.querySelector('.event-menu');
